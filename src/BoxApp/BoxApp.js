...
//         //"query":"1#select sym,asc size,time from select size:last sums(asize+bsize),last string time by sym from quote where time.date = .z.d",
...
//                   </tr>
//                   <div class="lastUpdated" align="center">Last Updated: {tableDatatoday.time.slice(11, 19)}</div>
//                 </div>
//               )
...
//     },
//     data: {
//       "query": "a:xdesc[`totalvol] select totalvol:sum asize+bsize by sym from quote where time.date=(.z.d-1)",
//       "type": "sync",
//       "response": true
//     }
//   }
